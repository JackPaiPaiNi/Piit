					...
					<div class="widget-main">
						<form id="form-search" class="form-search">
							<div class="row">
								<div class="col-xs-6 col-sm-3">
									<div class="input-group input-group-sm">
										<label class="input-group-addon">调价单号&nbsp;&nbsp;</label>
										<input type="text" name="tjdid" class="form-control"/>
									</div>
								</div>	
								<div class="col-xs-6 col-sm-3">
									<div class="input-group input-group-sm">
							...
							<div class="row">
								<div class="col-xs-6 col-sm-3">
									<div class="input-group input-group-sm">
										<label class="input-group-addon">调价状态&nbsp;&nbsp;</label>
...
<script type="text/javascript">
	...
	var isEdit = false;
	var editurl= "<c:url value='/price/skdPriceAdjust/editPage'/>";
	var delurl= "<c:url value='/price/skdPriceAdjust/delete'/>";
	<shiro:hasPermission name="price:skdPriceAdjust:edit">isEdit=true;</shiro:hasPermission>
	
	$(function($) {
		$(".skyselect").select2();
		$(grid_selector).bindTable({
			url: "<c:url value='/price/skdPriceAdjust/search'/>",
			...
			colModel: [
				...
				{name:'tjdid', index:'tjdid', label:'调价单号', width:80,  editrules:{edithidden:true}},
				{name:'zt', index:'zt', label:'状态',width:70, hidden:true},
				{name:'ztmc', index:'ztmc', label:'状态',width:70},
				{name:'ddid', index:'ddid', label:'订单号', width:100,  editrules:{edithidden:true}},
				...
				{name:'ddzje', index:'ddzje', label:'订单总金额', width:100,  editrules:{edithidden:true}},
				{name:'zje', index:'zje', label:'调整总金额', width:100,  editrules:{edithidden:true}},
		...
		$("#export").click(function(){
		    ...
		    if(curNum==0){
	        	...
	        	$("#export").bindSweetAlert({
	    			...
	    			callback:function(){
	    				$(grid_selector).exportExcel({url: "<c:url value='/price/skdPriceAdjust/export'/>"});
	    			}
	    		});
	        }
		});

...
<script type="text/javascript">
	...
	$(function($) {
		...
		$(grid_selector).bindTable({
			...
			rowNum : 100,
			colModel: [{name:'pp', index:'pp', label:'品牌', width:80},
		...
		$("#btn-search").click(function(){
			...
			$(grid_selector).bindTable({
				url: "<c:url value='/fcst/fcstReport/searchDemandSummaryTwo'/>",
				pager: pager_selector,
				gridParent: "#grid-parent",
				formSearch: "#form-search",
				shrinkToFit: false,
		...
		$("#export").click(function(){
		    ...
		    if(curNum==0){
	        	...
	        	$("#export").bindSweetAlert({
	    			...
	    			callback:function(){
	    				$(grid_selector).exportExcel({url: "<c:url value='/fcst/fcstReport/exportDemandSummaryTwo'/>"});
	    			}
	    		});
	        }
		});

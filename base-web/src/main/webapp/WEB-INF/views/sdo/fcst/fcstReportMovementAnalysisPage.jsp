...
<script type="text/javascript">
	...
	$(function($) {
		...
		$(grid_selector).bindTable({
			...
			rowNum : 100,
			colModel: [{name:'jixin', index:'jixin', label:'机芯', width:80}
			]
		},{
			add:false,
			edit:false,
		...
		$("#btn-search").click(function(){
			...
			$(grid_selector).bindTable({
				url: "<c:url value='/fcst/fcstReport/searchMovementAnalysis'/>",
				pager: pager_selector,
				gridParent: "#grid-parent",
				formSearch: "#form-search",
				shrinkToFit: false,
				...
				rowNum : 20,
				colModel: [{name:'jixin', index:'jixin', label:'机芯', width:100},
		...
		$("#export").click(function(){
		    ...
		    if(curNum==0){
	        	...
	        	$("#export").bindSweetAlert({
	    			...
	    			callback:function(){
	    				$(grid_selector).exportExcel({url: "<c:url value='/fcst/fcstReport/exportMovementAnalysis'/>"});
	    			}
	    		});
	        }
		});

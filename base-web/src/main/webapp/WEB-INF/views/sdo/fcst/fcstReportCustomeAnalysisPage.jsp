...
<script type="text/javascript">
	...
	$(function($) {
		...
		$(grid_selector).bindTable({
			...
			rowNum : 100,
			colModel: [{name:'xsymc', index:'xsymc', label:'销售员', width:80},
		...
		$("#btn-search").click(function(){
			...
			$(grid_selector).bindTable({
				url: "<c:url value='/fcst/fcstReport/searchCustomeAnalysis'/>",
				pager: pager_selector,
				gridParent: "#grid-parent",
				formSearch: "#form-search",
				shrinkToFit: false,
				...
				rowNum : 20,
				colModel: [{name:'xsymc', index:'xsymc', label:'销售员', width:100},
				           {name:'khmc', index:'khmc', label:'客户', width:223},
				           {name:'ycs1Sz', index:'ycs1Sz', label:'上周数量', width:65, align: "right"},
				           {name:'ycs1Bz', index:'ycs1Bz', label:'本周数量', width:65, align: "right"},
				           {name:'ycs1Cy', index:'ycs1Cy', label:'差异', width:65, align: "right"},
				           {name:'ycs2Sz', index:'ycs2Sz', label:'上周数量', width:65, align: "right"},
				           {name:'ycs2Bz', index:'ycs2Bz', label:'本周数量', width:65, align: "right"},
				           {name:'ycs2Cy', index:'ycs2Cy', label:'差异', width:65, align: "right"},
				           {name:'ycs3Sz', index:'ycs3Sz', label:'上周数量', width:65, align: "right"},
				           {name:'ycs3Bz', index:'ycs3Bz', label:'本周数量', width:65, align: "right"},
				           {name:'ycs3Cy', index:'ycs3Cy', label:'差异', width:65, align: "right"},
				           {name:'hjSz', index:'hjSz', label:'上周数量', width:65, align: "right"},
				           {name:'hjBz', index:'hjBz', label:'本周数量', width:65, align: "right"},
				           {name:'hjCy', index:'hjCy', label:'差异', width:65, align: "right"}]
			},{
				add:false,
				edit:false,
				del:false,
		...
		$("#export").click(function(){
		    ...
		    if(curNum==0){
	        	...
	        	$("#export").bindSweetAlert({
	    			...
	    			callback:function(){
	    				$(grid_selector).exportExcel({url: "<c:url value='/fcst/fcstReport/exportCustomeAnalysis'/>"});
	    			}
	    		});
	        }
		});

				...
				<div class="tab-content">
						...
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-6">
								<div class="input-group input-group-sm">
									...
									<select role="select" name="wkysbz" size="1" class="form-control skyselect skydisabled" disabled="disabled">
					...
					<div class="tab-pane fade" id="mgxx-tab">
						<div class="row" style="margin: 0px;">
							...
							<div class="col-xs-6 col-sm-3">
								<div class="input-group-sm">
									<input type="text" name="xlhbz" placeholder="序列号码" class="form-control skydisabled" disabled="disabled"/>
								</div>
							</div>
						</div>
						<div class="space-4"></div>
						<div class="row" style="margin: 0px;">
							<div class="col-xs-12 col-sm-12">
								<div class="input-group input-group-sm">
									...
									<input type="text" name="xlhqt" class="form-control skydisabled" disabled="disabled" >
								</div>
							</div>
						</div>
						<div class="space-4"></div>
...
<script type="text/javascript">
	...
	function selectDdidInit(){
		$.tableDialogPage({
		    ...
		    url:"<c:url value='/order/orderProductNew/search'/>"+"?zt=5"
		},{
			callback:function(rows){
				...
				var array = new Array("id","oper","sjc","bbh","taskId","ddid","ckddh","ddlb","bz",
						...
						"khbm","khmc","cylx","zt","tssapzt","zdrmc","zdsj","sfBg");
				// 根据参考订单号初始化数据
				$.bindAjax({

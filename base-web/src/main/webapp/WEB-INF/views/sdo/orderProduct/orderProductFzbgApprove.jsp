...
<div class="page-content">
	<form id="form-submit">
		...
		<blacklass="header blue" style="margin: 0; padding: 0;">备损物料信息</h5>
	    ...
	    <h5 class="header blue" style="margin: 0; padding: 0;">变更明细情况</h5>
			...
			<div class="row" align="center">
				...
				&nbsp;
				<shiro:hasPermission name="orderfzbg:orderProductFzbg:reject">
...
<script type="text/javascript">
	...
	function approve(type){
		...
		$("body").bindSweetAlert({
			...
			callback:function(){
				$.bindAjax({
					url:"<c:url value='/order/orderProductNewFzbg/approve'/>",
					data:param,
					action:"save"
				},function(response){

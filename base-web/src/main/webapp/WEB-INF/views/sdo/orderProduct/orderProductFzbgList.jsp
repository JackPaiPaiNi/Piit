...
<script type="text/javascript">
	...
	var editurl = "<c:url value='/order/orderProductNewFzbg/editPage'/>";
	var viewurl = "<c:url value='/order/orderProductNewFzbg/viewPage'/>";
	var changeurl = "<c:url value='/order/orderProductNewFzbg/change'/>";
	var getbackurl = "<c:url value='/order/orderProductNewFzbg/getback'/>";
	var isEdit = false;
	<shiro:hasPermission name="order:orderProductNewFzbg:edit">isEdit=true;</shiro:hasPermission>
	...
	$(function($) {
		...
		$(grid_selector).bindTable({
			caption: "",
			url: "<c:url value='/order/orderProductNewFzbg/search'/>",
		...
		<shiro:hasPermission name="order:orderProductNewFzbg:edit">
		...
		$("#btn-export").click(function(){
		    ...
		    if(curNum==0){
	        	...
	        	$("#export").bindSweetAlert({
	    			...
	    			callback:function(){
	    				$(grid_selector).exportExcel({url: "<c:url value='/order/orderProductNewFzbg/export'/>"});
	    			}
	    		});
	        }
		});
		...
		if(selr == null || selr == ""){
			...
			if (zt != 1 && zt != 3) {
				...
				$("body").bindSweetAlert({
					...
					callback:function(){
						$.bindAjax({
							url:"<c:url value='/order/orderProductNewFzbg/delete'/>",

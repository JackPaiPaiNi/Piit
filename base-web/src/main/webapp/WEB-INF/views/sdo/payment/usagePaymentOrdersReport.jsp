			...
			<div id="search-box" class="widget-box">
				...
				<div class="widget-body">
					<form id="form-search" name="form-search" class="form-search">
                         <div class="row">
							<input type ="hidden" value ="17" name ="lx">
						</div>	
					</form>
				</div>
			</div>
...
$(function($) {
	...
	var gridTable = $(grid_selector).bindTable({
		...
		rowNum : 20,
		colModel: [
			{name:'fktjmc', index:'fktjmc', label:'付款条件'},
			{name:'usd_je', index:'usd_je', label:'订单总金额（USD）'},
			{name:'rmb_je', index:'rmb_je', label:'订单总金额（RMB）'},
			{name:'usd_zb', index:'usd_zb', label:'占总订单的比例（USD）'}
		]
	},{
		add:false,
		edit:false,

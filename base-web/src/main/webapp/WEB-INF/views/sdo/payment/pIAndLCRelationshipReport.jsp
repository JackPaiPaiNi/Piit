...
$(function($) {
	...
	var gridTable = $(grid_selector).bindTable({
		...
		colModel: [
			...
			{name:'lc_yq', index:'lc_yq', label:'PI要求L/C金额'},
			{name:'lc_kzh', index:'lc_kzh', label:'L/C号'},
			{name:'lc_bz', index:'lc_bz', label:'L/C币种'},
			{name:'lc_ybd', index:'lc_ybd', label:'L/C绑定金额'},
			{name:'sfmz', index:'sfmz', label:'绑定是否满足要求'}
		]
	},{
		add:false,
		edit:false,

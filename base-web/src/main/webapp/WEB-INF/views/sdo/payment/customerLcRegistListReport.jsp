...
$(function($) {
	...
	var gridTable = $(grid_selector).bindTable({
		...
		colModel: [  
			...
			{name:'skyh', index:'skyh', label:'收款银行', width:80},
			{name:'skyhmc', index:'skyhmc', label:'收款银行名称', width:80},
			{name:'bz', index:'bz', label:'币种', width:80},
			{name:'je', index:'je', label:'收款金额', width:80},
			{name:'sjsxf', index:'sjsxf', label:'手续费', width:80},
			{name:'yrlje', index:'yrlje', label:'已认领金额', width:80},
			{name:'wrlje', index:'wrlje', label:'未认领金额', width:80}
		]
	},{
		add:false,
		edit:false,

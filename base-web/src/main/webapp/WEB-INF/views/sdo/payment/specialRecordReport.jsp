			...
			<div id="search-box" class="widget-box">
				...
				<div class="widget-body">
					<form id="form-search" name="form-search" class="form-search">
                         <div class="row">
							<input type ="hidden" value ="12" name ="lx">
						</div>	
					</form>
				</div>
			</div>
...
$(function($) {
	...
	var gridTable = $(grid_selector).bindTable({
		...
		colModel: [
			...
			{name:'ddje', index:'ddje', label:'订单总金额'},
			{name:'wkpje', index:'wkpje', label:'未开票金额'},
			{name:'ykpje', index:'ykpje', label:'已开票金额'},
			{name:'sf_yxc', index:'sf_yxc', label:'是否有未消除特批记录'}
		]
	},{
		add:false,
		edit:false,

			...
			<div id="search-box" class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						...
						<!-- 	<input type="hidden" name="sfwhjhwcsj" value="否"/> -->
							<div class="row">
	...
	$(function($) {
		...
		$(grid_selector).bindTable({
			...
			colModel: [
				...
				{name:'qrlx', label:'确认类型', hidden:true, editoptions:{dataInit: function(elem){$(elem).val("1")}},
			    ...
			    {name:'scjhwc', index:'scjhwc', label:'生产计划完成时间', width:80, formatter:'date',
				    editoptions:{dataInit:innitTime},formatoptions:{newformat:'Y-m-d'},formoptions:{rowpos: 3, colpos: 3}},
			    {name:'ckzgsj', index:'ckzgsj', label:'出库装柜时间', width:80, formatter:'date',
					editoptions:{dataInit:innitTime,readonly:"true"}, formatoptions:{newformat:'Y-m-d'},
		...
		$("#export").click(function(){
		    ...
		    if(data.length == 0){
	        	...
	        	$("#export").bindSweetAlert({
	    			...
	    			callback:function(){
	    			$(grid_selector).exportExcel({url: encodeURI("<c:url value='/track/trackValidation/plainTimeExport'/>"),
		...
		$('#import').click(function(){
			$.importDialog({
				title:"选择文件",
				url:"<c:url value='/track/trackValidation/plainTimeImport'/>"
			},{

	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="row" style="margin: 0px 8px;">
				...
				<input type="hidden" name="bbh" value="${orderSample.bbh}"/>
					...
					<tr>
						...
						<td style="width: 20%">
							...
							<c:if test="${sfApprove != 1}">
								<c:if test="${orderSample.zt == '4' || orderSample.zt == '5'}">
			...
			<!-- <div class="tab-content"> -->
				...
				<h5 class="header blue" style="margin: 0; padding: 0;">基本信息</h5>
					<div class="row" style="margin: 0px 8px;">
						<table cellspacing="0" cellpadding="0">
							...
							<%-- <tr>
								<td colspan="4"><b>辅助变更备注：</b><PRE class="pre">${orderSample.fzbgbz}</PRE></td>
							</tr> --%>
						</table>
					</div>
				<!-- </div> -->
					...
					<div class="row" style="margin: 0px 8px;">
						<table cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><b>型号：</b>${orderSample.jixing}</td>
							<!-- 	<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr> -->
								<td><b>主板型号：</b>${orderSample.zbxh}</td>
							...
							<shiro:hasPermission name="order:orderSample:price">
							<tr>
								<td><b>单价：</b><fmt:formatNumber value="${orderSample.dj}" pattern="#,##0.00"/></td>
								<td><b>加工费：</b><fmt:formatNumber value="${orderSample.jgf}" pattern="#,##0.00"/></td>
								<td><b>运费：</b><fmt:formatNumber value="${orderSample.yf}" pattern="#,##0.00"/></td>
								<td><b>单台总价：</b><fmt:formatNumber value="${orderSample.dtzj}" pattern="#,##0.00"/></td>
							</tr>
							</shiro:hasPermission>
							<tr>
								...
								<shiro:hasPermission name="order:orderSample:price">
								<td><b>总金额：</b><fmt:formatNumber value="${orderSample.zje}" pattern="#,##0.00"/></td>
								</shiro:hasPermission>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td colspan="2"><b>客户验货要求：</b><PRE class="pre">${orderSample.khyhyq}</PRE></td>
								<td colspan="2"><b>其他备注：</b><PRE class="pre">${orderSample.qtbz}</PRE></td>
							</tr>
						</table>
					</div>
				<!-- </div> -->
				...
				<h5 class="header blue" style="margin: 0; padding: 0;">产品详细功能需求</h5>
					...
					<div class="row" style="margin: 0px 8px;">
						<table cellspacing="0" cellpadding="0">
							...
							<tr>
								<td colspan="2"><b>待机功率 ：</b>${orderSample.djglmc}&nbsp;&nbsp;${orderSample.djglbz}</td>
								<td><b>OSD语言：</b>${orderSample.osdyy}</td>
								<td colspan="2"><b>附加功能：</b>
				...
				<h5 class="header blue" style="margin: 0; padding: 0;">结构特性</h5>
					<div class="space-4"></div>
					<div class="row" style="margin: 0px 8px;">
						<table cellspacing="0" cellpadding="0">
							<tr>

...
<script type="text/javascript">
	...
	var editurl = "<c:url value='/orderfzbg/orderSampleFzbg/editPage'/>";
	var viewurl = "<c:url value='/orderfzbg/orderSampleFzbg/viewPage'/>";
	var changeurl = "<c:url value='/orderfzbg/orderSampleFzbg/change'/>";
	var getbackurl = "<c:url value='/orderfzbg/orderSampleFzbg/getback'/>";
	var isEdit = false;
	...
	$(function($) {
		...
		$(grid_selector).bindTable({
			caption: "",
			url: "<c:url value='/orderfzbg/orderSampleFzbg/search'/>",
			...
			colModel: [
				...
				{name:'ddid', index:'ddid', label:'订单号', width:80, editoptions:{readonly:"true"}, frozen:true},
		...
		<shiro:hasPermission name="orderfzbg:orderSampleFzbg:edit">
		...
		$("#btn-export").click(function(){
		    ...
		    if(curNum==0){
	        	...
	        	$("#export").bindSweetAlert({
	    			...
	    			callback:function(){
	    				$(grid_selector).exportExcel({url: "<c:url value='/orderfzbg/orderSampleFzbg/export'/>"});
	    			}
	    		});
	        }
		});
		...
		if(selr == null || selr == ""){
			...
			if (zt != 1 && zt != 3) {
				...
				$("body").bindSweetAlert({
					...
					callback:function(){
						$.bindAjax({
							url:"<c:url value='/orderfzbg/orderSampleFzbg/delete'/>",

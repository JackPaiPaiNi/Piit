					...
					<div class="widget-main">
						<form id="form-search" class="form-search">
							<div class="row">
								...
								<div class="col-xs-6 col-sm-4">
									<div class="input-group input-group-sm">
										...
										<input type="text" name="chcjrq" class="form-control timeInterval"/>
										<input type="hidden" id="beginChcjrq" name="beginChcjrq"/>
										<input type="hidden" id="endChcjrq" name="endChcjrq"/>
							...
							<div class="row">
								<div class="col-xs-6 col-sm-4">
									<div class="input-group input-group-sm">
										<label class="input-group-addon">订单创建日期&nbsp;&nbsp;</label>
										<input type="text" name="ddcjrq" class="form-control timeInterval"/>
										<input type="hidden" id="beginDdcjrq" name="beginDdcjrq"/>
										<input type="hidden" id="endDdcjrq" name="endDdcjrq"/>
										<span class="input-group-addon">
											<i class="icon-calendar bigger-110"></i>
										</span>
									</div>
...
<script type="text/javascript">
	...
	$(function($) {
		$("#form-search [name=chcjrq]").bindDateRange({startElement:$("#beginChcjrq"),endElement:$("#endChcjrq")});
		$("#form-search [name=ddcjrq]").bindDateRange({startElement:$("#beginDdcjrq"),endElement:$("#endDdcjrq")});
		
		$(grid_selector).bindTable({
			caption: "",
			url: "<c:url value='/invoice/shippingInstruction/searchChxx'/>",
			...
			onCellSelect: function(rowid, iCol, cellcontent, e){
				if(iCol == 1){
					...
					var ids = $(grid_selector_select).jqGrid("getDataIDs");
					var i =0 ;
					...
					if(i > 0){
						...
						// 添加
						$(grid_selector_select).jqGrid("addRowData", rowData.id, rowData);
					}
				}
			}
		},{
	...
	// 删除
	function delfunc(){
		var selectedRowIds = $(grid_selector_select).jqGrid("getGridParam","selarrrow"); 

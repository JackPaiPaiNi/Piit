						...
						<form id="form-search" class="form-search">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12">
									<div class="input-group input-group-sm">
										<label class="input-group-addon">项目类别&nbsp;&nbsp;</label>
										<select multiple="" data-placeholder="请选择..." name="xmlb" class="width-80 chosen-select">
											 ${fns:loadDictOption('XMLB')}
										</select>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-xs-6 col-sm-12">
									<div class="input-group input-group-sm">
										...
										<textarea name="wlbh" class="autosize-transition form-control"></textarea>
									</div>
								</div>
							</div>
						</form>
...
<script type="text/javascript">
	...
	$(function($) {
		...
		$(grid_selector).bindTable({
			caption: "",
			url: "<c:url value='/invoice/invoicenew/searchMaterial'/>",
			...
			colModel: [
				...
				{name:'jhsl', index:'jhsl', label:'数量', width:80, align:'right', 
	...
	function save(flag){
		...
		if(data.length < 1){
			...
			$.bindAjax({
				url : "<c:url value='/invoice/invoicenew/saveMaterial'/>",

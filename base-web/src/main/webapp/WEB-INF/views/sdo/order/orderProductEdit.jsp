						...
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-6">
								<div class="input-group input-group-sm">
									...
									<input type="text" name="wkysbz" class="form-control skydisabled"/>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3" >
								<div class="input-group input-group-sm">
					...
					<div class="tab-pane fade" id="mgxx-tab">
						...
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<select role="select" name="mk" size="1" class="form-control skyselect skydisabled">
							...
							<div class="col-xs-6 col-sm-3">
								<div class="input-group-sm">
									<input type="text" name="mkbz" placeholder="面壳备注" class="form-control skydisabled"/>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									<label class="input-group-addon">装饰件&nbsp;&nbsp;</label>
									<select role="select" name="zsj" size="1" class="form-control skyselect skydisabled">
										${fns:loadDictOption('MG_LOGO')}
									</select>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group-sm">
									<input type="text" name="zsjbz" placeholder="装饰件备注" class="form-control skydisabled"/>
								</div>
							</div>
						</div>
						<div class="space-4"></div>
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<div class="form-control">
										<label class="radio-inline">
											<input type="radio" class="skyradio skydisabled" name="sfLogozxbg" value="1">是
										</label>
										<label class="radio-inline">
											<input type="radio" class="skyradio skydisabled" name="sfLogozxbg" value="0" checked="checked">否
										</label>
									</div>
								</div>
							</div>
						...
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<select role="select" name="ykq" size="1" class="form-control skyselect skydisabled">
							...
							<div class="col-xs-6 col-sm-3">
								<div class="input-group-sm">
									<input type="text" name="ykqbz" placeholder="遥控器选项备注" class="form-control skydisabled"/>
								</div>
							</div>
						</div>
						...
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<select role="select" name="sms" size="1" class="form-control skyselect skydisabled">
							...
							<div class="col-xs-6 col-sm-3">
								<div class="input-group-sm">
									<input type="text" name="smsbz" placeholder="说明书备注" class="form-control skydisabled"/>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									<label class="input-group-addon">说明书语种&nbsp;&nbsp;</label>
									<input name="smsyz" type="text" class="form-control skydisabled"  >
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									<label class="input-group-addon">语言排版顺序&nbsp;&nbsp;</label>
									<input name="yypbsx" type="text" class="form-control skydisabled" >
								</div>
							</div>
						</div>
						<div class="space-4"></div>
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<div class="form-control">
										<label class="radio-inline">
											<input type="radio" class="skyradio skydisabled" name="ksazzn" value="1">需要
										</label>
										<label class="radio-inline">
											<input type="radio" class="skyradio skydisabled" name="ksazzn" value="0" checked="checked">不需要
										</label>
									</div>
								</div>
							</div>
						...
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<select role="select" name="zx" size="1" class="form-control skyselect skydisabled">
							...
							<div class="col-xs-6 col-sm-3">
								<div class="input-group-sm">
									<input type="text" name="zxbz" placeholder="纸箱备注" class="form-control skydisabled"/>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									<label class="input-group-addon">印刷资料&nbsp;&nbsp;</label>
									<select role="select" name="yszl" size="1" class="form-control skyselect skydisabled">
						...
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<select role="select" name="hgtz" size="1" class="form-control skyselect skydisabled">
										${fns:loadDictOption('BZKTZSMS')}
									</select>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group-sm">
									<input type="text" name="hgtzbz" placeholder="后盖贴纸备注" class="form-control skydisabled"/>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									<label class="input-group-addon">POP贴纸&nbsp;&nbsp;</label>
									<select role="select" name="poptz" size="1" class="form-control skyselect skydisabled">
										${fns:loadDictOption('BZKTZSMS')}
									</select>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group-sm">
									<input type="text" name="poptzbz" placeholder="POP贴纸备注" class="form-control skydisabled"/>
								</div>
							</div>
						</div>	
						<div class="space-4"></div>
						<div class="row" style="margin: 0px;">	
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<select role="select" name="nxtz" size="1" class="form-control skyselect skydisabled">
										${fns:loadDictOption('BZKTZSMS')}
									</select>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group-sm">
									<input type="text" name="nxtzbz" placeholder="能效贴纸备注" class="form-control skydisabled"/>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									<label class="input-group-addon">适配器贴纸&nbsp;&nbsp;</label>
									<select role="select" name="spqtz" size="1" class="form-control skyselect skydisabled">
							...
							<div class="col-xs-6 col-sm-3">
								<div class="input-group-sm">
									<input type="text" name="spqtzbz" placeholder="适配器贴纸备注" class="form-control skydisabled"/>
								</div>
							</div>
						</div>
						...
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<select role="select" name="bzk" size="1" class="form-control skyselect skydisabled">
										${fns:loadDictOption('BZKTZSMS')}
									</select>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group-sm">
									<input type="text" name="bzkbz" placeholder="保证卡备注" class="form-control skydisabled"/>
								</div>
							</div>
						</div>
						...
						<div class="row" style="margin: 0px;">
						    <div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<div class="form-control">
										<label class="radio-inline">
											<input type="radio" class="skyradio skydisabled" name="dzazsm" value="1" checked="checked">需要
										</label>
										<label class="radio-inline">
											<input type="radio" class="skyradio skydisabled" name="dzazsm" value="0">不需要
										</label>
									</div>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<input name="dzazsmsyz" type="text" class="form-control skydisabled" >
								</div>
							</div>
						</div>
						...
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<select role="select" name=xlh size="1" class="form-control skyselect skydisabled">
							...
							<div class="col-xs-6 col-sm-3">
								<div class="input-group-sm">
									<input type="text" name="xlhbz" placeholder="序列号备注" class="form-control skydisabled"/>
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									<label class="input-group-addon">用量&nbsp;&nbsp;</label>
									<input name="yl" type="text" class="form-control skydisabled" >
								</div>
							</div>
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									<label class="input-group-addon">粘贴位置要求&nbsp;&nbsp;</label>
									<input name="ztwzyq" type="text" class="form-control skydisabled" >
								</div>
							</div>
						</div>
						<div class="space-4"></div>
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<select role="select" name="ccyq" size="1" class="form-control skyselect skydisabled">
						...
						<div class="row" style="margin: 0px;">
							<div class="col-xs-6 col-sm-3">
								<div class="input-group input-group-sm">
									...
									<select role="select" name="xyzfyfs" size="1" class="form-control skyselect skydisabled">
						...
						<div class="row" style="margin: 0px;">
							<div class="input-group input-group-sm" >
								<div class="form-control">
									<label class="checkbox-inline">
										<input type="checkbox" class="skycheckbox skydisabled" name="ztgmgzlMk" value="1">面壳
									</label>
									<label class="checkbox-inline">
							      		<input type="checkbox" class="skycheckbox skydisabled" name="ztgmgzlZsj" value="1">装饰件
							      	</label>
							      	<label class="checkbox-inline">
							      		<input type="checkbox" class="skycheckbox skydisabled" name="ztgmgzlYkq" value="1">遥控器
							     	</label>
							     	<label class="checkbox-inline">
							     		<input type="checkbox" class="skycheckbox skydisabled" name="ztgmgzlSms" value="1">说明书
							     	</label>
							     	<label class="checkbox-inline">
							     		<input type="checkbox" class="skycheckbox skydisabled" name="ztgmgzlZx" value="1">纸箱
							    	</label>
							    	<label class="checkbox-inline">
							    		<input type="checkbox" class="skycheckbox skydisabled" name="ztgmgzlHgtz" value="1">后盖贴纸
							    	</label>
							    	<label class="checkbox-inline">
							    		<input type="checkbox" class="skycheckbox skydisabled" name="ztgmgzlPoptz" value="1">POP贴纸
							  		</label>
							  		<label class="checkbox-inline">
							    		<input type="checkbox" class="skycheckbox skydisabled" name="ztgmgzlNxtz" value="1">能效贴纸
							  		</label>
							  		<label class="checkbox-inline">
							    		<input type="checkbox" class="skycheckbox skydisabled" name="ztgmgzlSpqtz" value="1">适配器贴纸
							  		</label>
							  		<label class="checkbox-inline">
							    		<input type="checkbox" class="skycheckbox skydisabled" name="ztgmgzlBzk" value="1">保证卡
							  		</label>
							  		<label class="checkbox-inline">
							    		<input type="checkbox" class="skycheckbox skydisabled" name="ztgmgzlDzazsm" value="1">底座安装说明
							  		</label>
							  		<label class="checkbox-inline">
							    		<input type="checkbox" class="skycheckbox skydisabled" name="ztgmgzlZjxhtz" value="1">整机序号贴纸
							  		</label>
							  	</div>
							</div>
						</div>
...
<script type="text/javascript">
		 ...
		 url: "<c:url value='/pub/data/searchDhdd'/>?zt=5" 
			...
			callback:function(rows){
				...
				if(rows){
					...
					//以下值当为不需要时，显示不需要的选项
					if(rows.ykq == "4"){
						$("#form-submit [name=ykq]").select2("val",rows.ykq);
					}else{
						$("#form-submit [name=ykq]").select2("val",3);
					}
					if(rows.sms =="3"){
						$("#form-submit [name=sms]").select2("val",rows.sms);
					}else{
						$("#form-submit [name=sms]").select2("val",2);
					}
					if(rows.zx =="4"){
						$("#form-submit [name=zx]").select2("val",rows.zx);
					}else{
						$("#form-submit [name=zx]").select2("val",1);
					}
					if(rows.hgtz =="3"){
						$("#form-submit [name=hgtz]").select2("val",rows.hgtz);
					}else{
						$("#form-submit [name=hgtz]").select2("val",2);
					}
					if(rows.poptz =="3"){
						$("#form-submit [name=poptz]").select2("val",rows.poptz);
					}else{
						$("#form-submit [name=poptz]").select2("val",2);
					}
					if(rows.nxtz =="3"){
						$("#form-submit [name=nxtz]").select2("val",rows.nxtz);
					}else{
						$("#form-submit [name=nxtz]").select2("val",2);
					}
					if(rows.spqtz =="5"){
						$("#form-submit [name=spqtz]").select2("val",rows.spqtz);
					}else{
						$("#form-submit [name=spqtz]").select2("val",4);
					}
					if(rows.bzk =="3"){
						$("#form-submit [name=bzk]").select2("val",rows.bzk);
					}else{
						$("#form-submit [name=bzk]").select2("val",2);
					}
					//面壳备注、装饰品备注 从参考订单号带出面壳、装饰品名称
					$("#form-submit [name=mkbz]").val(rows.mkmc);
					$("#form-submit [name=zsjbz]").val(rows.zsjmc);
					
				// 参考订单号不需要赋值的字段
				var array = new Array("id","oper","sjc","bbh","taskId","ddid","ckddh","ddlb","bz",
						"fktj","fktjmc","gjmytk","gjmytkmc","sl","dj","je","ffbsje","zje",/* "zhfs", */"jhrq",
						"khbm","khmc","cylx","bzkbz","hgtzbz","smsbz","zxbz","poptzbz","khlogobz",
						"ykqckddh","zt","xsyid","xsymc",/* "mkbz","zsjbz", */"ykqbz","nxtzbz","spqtzbz", "mk", "zsj", "ykq", 
						"sms", "hgtz", "poptz", "nxtz", "spqtz", "bzk", "tssapzt","zdrmc","zdsj","sfBg","yddid",
						"mfbsqdfj","ffbsqdfj","cbuwlfj","kjlogofj","shckdjgyqbz","shckdxcxwlmxfj","cpqtyqfj","mgqtyqfj","sfMzckd","gsbm");
				// 根据参考订单号初始化数据
				$.bindAjax({
	...
	function initStaticValue(){
		if(id == "null"){
			...
			//适配器默认为不需要，灰掉适配器贴纸
			$('#form-submit [name=spqtz]').prop('disabled','disaled');
			$('#form-submit [name=spqtzbz]').prop('disabled','disaled');
		}
	};
	// PID选择
				...
				if(rows){
				    ...
				    if(wsxh.length>0){
				    	...
				    	if (cc <= 32){
				    		...
				    		$('#form-submit [name=spqtz]').removeProp("disabled").removeAttr('disabled');
							$('#form-submit [name=spqtzbz]').removeProp("disabled").removeAttr('disabled');
				    	}else{
	...
	function initPageData(id){
		if(id == "null"){
			...
			$.bindAjax({
				...
				//POP初始化
				if(response.dzpop == "0" && response.ddlb != "3"){

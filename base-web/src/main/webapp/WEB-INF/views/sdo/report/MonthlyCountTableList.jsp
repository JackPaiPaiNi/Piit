...
<script type="text/javascript">
	...
	$(function($) {
		...
		$(grid_selector).bindTable({
			url: "<c:url value='/report/MonthlyCountTable/search'/>",
			datatype : "local",
			...
			colModel: [
				...
				{name:'hwgylsl', index:'hwgylsl', label:'海外供应链数量', width:110, align:'right', formatter:'integer',formatoptions:{thousandsSeparator: ','}},
				{name:'zchsl', index:'zchsl', label:'总出货数量', width:90, align:'right', formatter:'integer',formatoptions:{thousandsSeparator: ','}},
				{name:'dykcsl', index:'dykcsl', label:'当月开船数量', width:100, align:'right', formatter:'integer',formatoptions:{thousandsSeparator: ','}},
				...
				{name:'dykcje', index:'dykcje', label:'当月开船金额USD', width:120, align:'right', formatter:'number',formatoptions:{thousandsSeparator: ','}},
				{name:'dyjzje', index:'dyjzje', label:'当月在途结转下月开船金额', width:190, align:'right', formatter:'number',formatoptions:{thousandsSeparator: ','}},
		...
		$("#btn-export").click(function(){
		    ...
		    if(curNum==0){
	        	...
	        	$("#export").bindSweetAlert({
	    			...
	    			callback:function(){
	    				$(grid_selector).exportExcel({url: "<c:url value='/report/MonthlyCountTable/export'/>"});
	    			}
	    		});
	        }
		});

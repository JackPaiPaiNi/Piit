...
<script type="text/javascript">
	...
	var editurl = "<c:url value='/pi/piFy/editPage'/>";
	var viewurl = "<c:url value='/pi/piFy/viewPage'/>";
	var delurl = "<c:url value='/pi/piFy/delete'/>";
	var searchurl= "<c:url value='/pi/piFy/search'/>"+ "?sfDyhpi=2";//只查询pilx=7,8,9,10
	var expurl = "<c:url value='/pi/piFy/export'/>";
	var changeurl = "<c:url value='/pi/piFy/change'/>";
	var bfchangeurl = "<c:url value='/pi/piFy/bfchange'/>";
	var cancelurl = "<c:url value='/pi/piFy/cancel'/>";
	var getbackurl = "<c:url value='/pi/piFy/getback'/>";
	var isEdit = false;
	...
	$(function($) {
		...
		<shiro:hasPermission name="pi:piFy:edit">

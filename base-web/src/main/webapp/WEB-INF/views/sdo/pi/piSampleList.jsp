					...
					<div class="widget-main">
						<form id="form-search" class="form-search">
							<div class="row">
								...
								<input type ="hidden" name="pilx" id="pilx" value="3">
								<div class="col-xs-6 col-sm-3">
									<div class="input-group input-group-sm">
...
<script type="text/javascript">
	...
	var editurl = "<c:url value='/pi/piSample/editPage'/>";
	var viewurl = "<c:url value='/pi/piSample/viewPage'/>";
	var delurl = "<c:url value='/pi/piSample/delete'/>";
	var searchurl= "<c:url value='/pi/piSample/search'/>";
	var expurl = "<c:url value='/pi/piSample/export'/>";
	var changeurl = "<c:url value='/pi/piSample/change'/>";
	var bfchangeurl = "<c:url value='/pi/piSample/bfchange'/>";
	var cancelurl = "<c:url value='/pi/piSample/cancel'/>";
	var getbackurl = "<c:url value='/pi/piSample/getback'/>";
	var isEdit = false;
	...
	$(function($) {
		...
		<shiro:hasPermission name="pi:piSample:edit">

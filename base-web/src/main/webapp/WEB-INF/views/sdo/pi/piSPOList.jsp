...
<script type="text/javascript">
	...
	var editurl = "<c:url value='/pi/piSPO/editPage'/>";
	var printUrl = "<c:url value='/pi/piSPO/print'/>";
	var viewurl = "<c:url value='/pi/piSPO/viewPage'/>";
	var delurl = "<c:url value='/pi/piSPO/delete'/>";
	var searchurl= "<c:url value='/pi/piSPO/search'/>";
	var expurl = "<c:url value='/pi/piSPO/export'/>";
	var changeurl = "<c:url value='/pi/piSPO/change'/>";
	var bfchangeurl = "<c:url value='/pi/piSPO/bfchange'/>";
	var cancelurl = "<c:url value='/pi/piSPO/cancel'/>";
	var getbackurl = "<c:url value='/pi/piSPO/getback'/>";
	var isEdit = false;
	...
	$(function($) {
		...
		<shiro:hasPermission name="pi:piSPO:edit">

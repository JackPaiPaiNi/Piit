...
<body>
	...
	<table class="print_table" cellspacing="0" cellpadding="0">
		<tr>
			<th colspan="8" style="font-size: 13px; text-align: left;">补充信息</th>
		</tr>
		<tr>
			<td style="width: 10%;"><b>跟单备损：</b></td>
			<td colspan="7" style="width: 90%;">${PsoVo.bcGdbs}</td>
		</tr>
		<tr>
			<td style="width: 10%;"><b>SPO备损：</b></td>
			<td colspan="7" style="width: 90%;">${PsoVo.bcSpobs}</td>
		</tr>
		<tr>
			<td  style="width: 10%;"><b>文件要求：</b></td>
			<td  colspan="7" style="width: 90%;">${PsoVo.bcWjyq}</td>
		</tr>
		<tr>
			<td  style="width: 10%;"><b>装柜要求：</b></td>
			<td  colspan="7" style="width: 90%;">${PsoVo.bcZgyq}</td>
		</tr>
		<tr>
			<td  style="width: 10%;"><b>其他备注：</b></td>
			<td  colspan="7" style="width: 90%;">${PsoVo.bcQt}</td>
		</tr>
	</table>
	<br>
	<table class="print_table" cellspacing="0" cellpadding="0">

								...
								<div class="row">
									<div class="col-xs-6 col-sm-3">
										<div class="input-group input-group-sm">
											...
											<input type="hidden" name="sfDyhyzh" value="3">
										</div>
									</div>
									<div class="col-xs-6 col-sm-3">
										<div class="input-group input-group-sm">
...
<script type="text/javascript">
	...
	var isEdit = false;
	var editurl = "<c:url value='/pso/fyPso/editPage'/>";
	var viewurl = "<c:url value='/pso/fyPso/viewPage'/>";
	var delurl = "<c:url value='/pso/fyPso/delete'/>";
	var changeurl = "<c:url value='/pso/fyPso/change'/>";
	var cancelurl = "<c:url value='/pso/fyPso/cancel'/>";
	var getbackurl = "<c:url value='/pso/fyPso/getback'/>";
	...
	$(function($) {
		...
		<shiro:hasPermission name="pso:fyPso:edit">
		...
		<shiro:hasPermission name="pso:fyPso:smoApprove">
		$(grid_selector).navButtonAdd(pager_selector,{
			...
			onClickButton: function(){
				...
				if(id==null || id==""){
					...
					$.bindAjax({
						url:"<c:url value='/pso/fyPso/smoApprove'/>",
						data:{id:id, sjc:rowData.sjc},
						action:"save"
					},function(response){
						$(grid_selector).trigger("reloadGrid");

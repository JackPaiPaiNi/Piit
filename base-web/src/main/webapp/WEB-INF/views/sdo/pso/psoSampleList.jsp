								...
								<div class="row">
									<div class="col-xs-6 col-sm-3">
										<div class="input-group input-group-sm">
											...
											<input type ="hidden" name="yzhlx" value="3">
									...
									<div class="col-xs-6 col-sm-3">
										<div class="input-group input-group-sm">
										    ...
										    <select role="select" name="gsbm"  size="1" class="form-control skyselect parent-node">
...
<script type="text/javascript">
	...
	var isEdit = false;
	var editurl = "<c:url value='/pso/samplePso/editPage'/>";
	var delurl = "<c:url value='/pso/samplePso/delete'/>";
	var viewurl = "<c:url value='/pso/samplePso/viewPage'/>";
	var changeurl = "<c:url value='/pso/samplePso/change'/>";
	var cancelurl = "<c:url value='/pso/samplePso/cancel'/>";
	var getbackurl = "<c:url value='/pso/samplePso/getback'/>";
	...
	$(function($) {
		...
		$(grid_selector).bindTable({
			...
			colModel : [ 
	             ...
	             { name : 'zt', index : 'zt', label:'状态',hidden :true, width : 60}, 
		...
		<shiro:hasPermission name="pso:samplePso:edit">
		...
		<shiro:hasPermission name="pso:samplePso:smoApprove">
		$(grid_selector).navButtonAdd(pager_selector,{
			...
			onClickButton: function(){
				...
				if(id==null || id==""){
					...
					$.bindAjax({
						url:"<c:url value='/pso/samplePso/smoApprove'/>",
						data:{id:id, sjc:rowData.sjc},
						action:"save"
					},function(response){
						$(grid_selector).trigger("reloadGrid");

...
<body>
	...
	<table class="print_table" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td style="width: 15%;"><fmt:formatDate value="${PsoVo.zgsj}" pattern="yyyy-MM-dd" /></td>
			<td style="width: 5%;"><b>挂架：</b></td>
			<td style="width: 20%;">
		...
		<tr>
			...
			<td colspan="7" style="width: 15%;">${fn:replace(fjxx,'red', '')}</td>
		</tr>
		<tr>
	...
	<table class="print_table" cellspacing="0" cellpadding="0">
		<tr>
			<th colspan="2" style="font-size: 13px; text-align: left;">补充信息</th>
		</tr>
		<tr>
			<td style="width: 10%;"><b>跟单备损:</b></td>
			<td style="width: 90%;">${PsoVo.bcGdbs}</td>
		</tr>
		<tr>
			<td style="width: 10%;"><b>SPO备损:</b></td>
			<td style="width: 90%;">${PsoVo.bcSpobs}</td>
		</tr>
		<tr>
			<td style="width: 10%;"><b>文件要求:</b></td>
			<td style="width: 90%;">${PsoVo.bcWjyq}</td>
		</tr>
		<tr>
			<td style="width: 10%;"><b>装柜要求:</b></td>
			<td style="width: 90%;">${PsoVo.bcZgyq}</td>
		</tr>
		<tr>
			<td style="width: 10%;"><b>其他备注:</b></td>
			<td style="width: 90%;">${PsoVo.bcQt}</td>
		</tr>
	</table>
	<br>
	<table class="print_table" cellspacing="0" cellpadding="0">

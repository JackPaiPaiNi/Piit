...
<%@include file="/WEB-INF/views/index/lfs.jsp"%><script type="text/javascript">
	$(function($) {
		$('.skyselect').select2();
		// 运费附件信息
			...
			<div class="col-xs-12">
				...
				<form id="form-submit">
					...
					<div class="row">
						...
						<c:import url="/pso/samplePso/viewPage" charEncoding="UTF-8">
...
<script type="text/javascript">
	...
	function approve(type){
		...
		$("#body").bindSweetAlert({
			...
			callback:function(){
				$.bindAjax({
					url:"<c:url value='/pso/samplePso/cwyclSave'/>",
					data:param,
					action:"save",
				},function(response){

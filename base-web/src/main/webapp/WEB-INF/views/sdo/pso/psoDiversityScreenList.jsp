								...
								<div class="row">
									<div class="col-xs-6 col-sm-3">
										<div class="input-group input-group-sm">
											...
											<input type="hidden" name="sfDyhyzh" value="2">
										</div>
									</div>
									<div class="col-xs-6 col-sm-3">
										<div class="input-group input-group-sm">
...
<script type="text/javascript">
	...
	var isEdit = false;
	var editurl = "<c:url value='/pso/diversityPso/editPage'/>";
	var viewurl = "<c:url value='/pso/diversityPso/viewPage'/>";
	var delurl = "<c:url value='/pso/diversityPso/delete'/>";
	var changeurl = "<c:url value='/pso/diversityPso/change'/>";
	var cancelurl = "<c:url value='/pso/diversityPso/cancel'/>";
	var getbackurl = "<c:url value='/pso/diversityPso/getback'/>";
	<shiro:hasPermission name="pso:diversityPso:edit">isEdit = true;</shiro:hasPermission>

	$(function($) {
		$('.skyselect').select2();
		$('#form-search [name=yzhlx]').select2('val','2');
		...
		$(grid_selector).bindTable({
			...
			colModel : [ 
	             ...
	             { name : 'scjdmc', index : 'scjdmc', label : '发货公司', width : 80 }, 
		...
		<shiro:hasPermission name="pso:diversityPso:edit">
		...
		<shiro:hasPermission name="pso:diversityPso:smoApprove">
		$(grid_selector).navButtonAdd(pager_selector,{
			...
			onClickButton: function(){
				...
				if(id==null || id==""){
					...
					$.bindAjax({
						url:"<c:url value='/pso/diversityPso/smoApprove'/>",
						data:{id:id, sjc:rowData.sjc},
						action:"save"
					},function(response){
						$(grid_selector).trigger("reloadGrid");

					...
					<div class="widget-main">
						<form class="form-search">
								<div class="row">
									...
									<div class="col-xs-6 col-sm-3">
										<div class="input-group">
											<label class="input-group-btn">模块名称&nbsp;&nbsp;</label>
...
<script type="text/javascript">
	...
	jQuery(function($) {
		jQuery(grid_selector).bindTable({
			url: "<c:url value='/base/resModule/search'/>",
			editurl: "<c:url value='/base/resModule/edit'/>",
			pager: pager_selector,
			gridParent:"#grid-parent",
			colModel: [
				{name:'id',index:'id',label:'ID',width:60, editable:false, sorttype:"int",hideCol:false},
				{name:'module',index:'module',label:'模块', width:100, editoptions:{size:"20",maxlength:"30"}},
				{name:'moduleName',index:'moduleName',label:'模块标识', width:100, editoptions:{size:"20",maxlength:"30"}},
				{name:'status',index:'status',label:'状态', width:70, edittype:"select",formatter: "select",editoptions: {value:"1:启用;0:禁用"}},
				{name:'description',index:'description',label:'描述', width:150, sortable:false,edittype:"textarea", editoptions:{rows:"2",cols:"18"}} 
			]
		},{
			add:isEdit,
			del:isEdit,

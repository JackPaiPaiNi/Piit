				...
				<div class="col-sm-6">
					<div class="widget-box">
						<div class="widget-header header-color-blue2">
							<h4 class="lighter smaller">地区树</h4>
							<div class="widget-toolbar no-border">
								<button id="addRoot" type="button" class="btn btn-success btn-minier bigger">
									<i class="icon-plus bigger-110"></i>
									新增国家
								</button>
								&nbsp;
								<button id="pdaInfoExport" type="button" class="btn btn-minier bigger">
									<i class="icon-download-alt icon-on-right"></i>
									导出
								</button>
								&nbsp;
								<button id="btnSearch" type="button" class="btn btn-info btn-minier bigger">
				...
				<div class="col-sm-6">
					<div class="widget-box">
						<div class="widget-header header-color-green2">
							<h4 class="lighter smaller">地区信息</h4>
						</div>
							...
							<div class="widget-main padding-8">
								<form class="form-submit">
									...
									<div class="row">
										<div class="col-xs-10 col-md-offset-1">
											<div class="input-group input-group-sm">
												<label class="input-group-addon">上级节点：&nbsp;&nbsp;</label>
									...
									<div class="row">
										<div class="col-xs-10 col-md-offset-1">
											<div class="input-group input-group-sm">
												<label class="input-group-addon">中文全称：&nbsp;&nbsp;</label>
									...
									<div class="row">
										<div class="col-xs-10 col-md-offset-1">
											<div class="input-group input-group-sm">
												<label class="input-group-addon">英文全称：&nbsp;&nbsp;</label>
									...
									<div class="row">
										<div class="col-xs-10 col-md-offset-1">
											<div class="input-group input-group-sm">
												<label class="input-group-addon">级&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：&nbsp;&nbsp;</label>
									...
									<div class="row">
										<div class="col-xs-10 col-md-offset-1">
											<div class="input-group input-group-sm">
												<label class="input-group-addon">排&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;序：&nbsp;&nbsp;</label>
									...
									<div class="row">
										<div class="col-xs-10 col-md-offset-1">
											<div class="input-group input-group-sm">
												<label class="input-group-addon">首都时区：&nbsp;&nbsp;</label>
												<input type="text" name="sdsq" exportColNames="首都时区" class="form-control"/>
											</div>
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="space-4"></div>
									<div class="row">
										<div style="border-top:1px solid #e5e5e5;margin: 13px 40px;padding: 12px 14px 6px;width:90%;">
											<div class="center">

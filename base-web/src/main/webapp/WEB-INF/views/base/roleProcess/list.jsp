					...
					<div class="widget-main">
						<form class="form-search">
								<div class="row">
									...
									<div class="col-xs-6 col-sm-3">
										<div class="input-group">
											<label class="input-group-btn">角色编号&nbsp;&nbsp;</label>
									...
									<div class="col-xs-6 col-sm-3">
										<div class="input-group">
											<label class="input-group-btn">模块标示&nbsp;&nbsp;</label>
...
<script type="text/javascript">
	...
	var isEdit = false;
	<shiro:hasPermission name="roleProcess:edit">isEdit=true;</shiro:hasPermission>
	
	jQuery(function($) {
		jQuery(grid_selector).bindTable({
			url: "<c:url value='/base/roleProcess/search'/>",
			editurl: "<c:url value='/base/roleProcess/edit'/>",
			...
			colModel: [
				...
				{name:'roleCode',index:'roleCode',label:'角色编号', width:100, editoptions:{size:"20",maxlength:"30"}},
				{name:'nodeCode',index:'nodeCode',label:'节点编码', width:100, editoptions:{size:"20",maxlength:"30"}},
				{name:'module',index:'module',label:'模块标示', width:100, editoptions:{size:"20",maxlength:"30"}},

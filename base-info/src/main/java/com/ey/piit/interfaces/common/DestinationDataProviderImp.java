...
public class DestinationDataProviderImp implements DestinationDataProvider {
	/**
	 * DestinationDataProvider is an interface We define
	 * DestinationDataProviderImp class to implements this interface so that we
	 * can define the logon parameters more flexibly not just in
	 * xxx.jcodestionation file.
	 * 

...
public class SAPConn {
	private static final SAPConn single = new SAPConn();
	private static final String ABAP_AS_POOLED = "HW_ABAP_AS_WITH_POOL" ;
	//测试库服务器海外SAP 172.20.1.186  制造sap  172.20.1.63  HW NEW 172.20.1.189 
	//海外SAP RAC : 172.20.1.182 制造SAP RAC:172.20.1.61
	private static String JCO_ASHOST ="172.20.1.182";
	private static String JCO_USER ="SDO01";//测试库SAP用户名 
	private static String JCO_PASSWD ="654321";//测试库密码  
	private static String ZS_JCO_ASHOST ="172.20.1.182";//正式库服务器
	...
	private static String JCO_CLIENT = "600";//正式库SAP集团 测试环境 130  HW NEW 600
	...
	public static SAPConn getInstance(){
		return SAPConn.single;
	}
	static {

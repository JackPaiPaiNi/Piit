...
public class DestinationProviderHW
{    
    private static Properties setProperties()
    {    
        // logon parameters and other properties
        Properties connProps = new Properties();        
        connProps.setProperty(DestinationDataProvider.JCO_ASHOST, "172.20.1.182");//开发机：172.20.1.186，测试机：172.20.1.189，正式机：172.20.1.182

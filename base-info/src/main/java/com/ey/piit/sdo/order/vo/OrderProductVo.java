...
import com.ey.piit.sdo.order.entity.OrderProduct;
 ...
 * @author 魏诚
 */
public class OrderProductVo extends OrderProduct implements Serializable {
	...
	private Integer sfCk;//是否参考（被PI参考时取全部订单）
	...
	public OrderProductVo(String id){
		super(id);
	}

 ...
 */
@Controller
@RequestMapping(value = "pso/diversityPso")
public class DiversityPsoController extends BaseController {
	 ...
	 * @return
	 */
	@RequiresPermissions("pso:diversityPso:view")
	@RequestMapping(value = { "list", "" })
	public ModelAndView diversityList() {
		ModelAndView view = new ModelAndView("sdo/pso/psoDiversityList");
		return view;
	}
	...
	public ModelAndView screenDiversityList() {
		ModelAndView view = new ModelAndView("sdo/pso/psoDiversityScreenList");
		return view;
	}
	...
	public String editPage() {
		return "sdo/pso/psoDiversityEdit";
	}
	 ...
	 * @return
	 */
	@RequiresPermissions("pso:diversityPso:edit")
	...
	public ModelAndView viewPage(String id) {
		ModelAndView view = new ModelAndView("sdo/pso/psoDiversityView");
	...
	public ModelAndView printPage(String id) {
		ModelAndView view = new ModelAndView("sdo/pso/psoDiversityPrint");
		view.addObject("PsoVo", psoService.callQueryById(id));
		return view;
	}	
	/**
	...
	public ModelAndView approvePage() {
		ModelAndView view = new ModelAndView("sdo/pso/psoDiversityApprove");
		return view;
	}
    ...
    /**
     * @function 多元化预走货撤回取消（type：1取消 2撤回）
     * @param vo
     */
    @RequiresPermissions("pso:diversityPso:edit")
	...
	public String cwfpApprovePage() {
		return "sdo/pso/psoDiversityCwfp";
	}
	...
	public String cwyclEditPage() {
		 return "sdo/pso/psoDiversityCwycl";
	}

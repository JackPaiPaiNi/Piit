...
import com.ey.piit.sdo.invoice.entity.ShippingInstructionItem;

/**
 * 补料单信息维护Entity
 * @author 高文浩
 */
public class ShippingInstructionItemVo extends ShippingInstructionItem {
	...
	public ShippingInstructionItemVo() {
		super();
	}

	public ShippingInstructionItemVo(String id){
		super(id);
	}

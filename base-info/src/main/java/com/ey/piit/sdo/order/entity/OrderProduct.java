...
public class OrderProduct extends BaseEntity {
	...
	private Integer sfLogozxbg;// LOGO造型是否变更
	...
	public Integer getKsazzn() {
		return ksazzn;
	}

	public void setKsazzn(Integer ksazzn) {
		this.ksazzn = ksazzn;
	}
	...
	public Integer getSfLogozxbg() {
		return sfLogozxbg;
	}

	public void setSfLogozxbg(Integer sfLogozxbg) {
		this.sfLogozxbg = sfLogozxbg;
	}
